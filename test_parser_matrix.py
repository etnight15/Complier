...
def main():
    cases = [
        ...
        ("con=st X: real = 1.0;", 0, 1, "const_typo_with_equal"),
        ("con;st X: real = 1.0;", 0, 1, "const_typo_with_semicolon"),
        ...
        ("const ; X: real = 1.0;", 0, 1, "stray_semicolon_before_name"),
        ("const ;; X: real = 1.0;", 0, 1, "double_semicolon_before_name"),
        ("; X: real = 1.0;", 0, 1, "leading_spurious_semicolon"),
